...
<section style={styles.pinLaoyut}>
  <img 
      src={require('./angele-kamp-uXzkLmnZ-d8-unsplash.jpg').default}
      alt="example1" 
      style={styles.pinLaoyutImg}
  />
  <img 
      src={require('./boat-4899802_1920.jpg').default}
      alt="example2" 
      style={styles.pinLaoyutImg}
  />
  <img 
      src={require('./dimitry-b-Nj43Yu4QW9E-unsplash.jpg').default}
      alt="example3" 
      style={styles.pinLaoyutImg}
  />
  <img 
      src={require('./julian-silverman-fLji1fIQs6c-unsplash.jpg').default} 
      alt="example4" 
      style={styles.pinLaoyutImg}
  />
  <img 
      src={require('./julian-silverman-GkVWxzR6wec-unsplash.jpg').default} 
      alt="example5" 
      style={styles.pinLaoyutImg}
  />
  <img 
      src={require('./tezos-y8wjQZ9XP4A-unsplash.jpg').default}
      alt="example6" 
      style={styles.pinLaoyutImg}
  />
  <img 
      src={require('./zieben-vh-kEmY4CURQfA-unsplash.jpg').default}
      alt="example7" 
      style={styles.pinLaoyutImg}
  />
  <img 
      src={require('./angele-kamp-lvnYKrVyW14-unsplash.jpg').default} 
      alt="example8" 
      style={styles.pinLaoyutImg}
  />
  <img 
      src={require('./tezos-urt6J6IK0yk-unsplash.jpg').default} 
      alt="example8" 
      style={styles.pinLaoyutImg}
  />
  <img 
      src={require('./tom-hills-sS3V2TnN0pc-unsplash.jpg').default} 
      alt="example10" 
      style={styles.pinLaoyutImg}
  />
</section>