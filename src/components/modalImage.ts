class ModalImg extends HTMLElement {
  ...
  connectedCallback() {
    ...
    // event
    const modalOpts: any = shadowRoot.querySelector('.myModal');
    const img: any = shadowRoot.querySelector('.myImg');
    const title: any = shadowRoot.querySelector('.caption');
    const close: any = shadowRoot.querySelector('.close');
